...
@MapperScan(basePackages = "com.stoneitgt.sogongja.admin.mapper", sqlSessionFactoryRef = DataSourceConfig.PRIMARY_SESSION_FACTORY)
public class MyBatisConfigPrimary {
	...
	public SqlSessionFactory sqlSessionFactory() throws Exception {
		...
		// Mapper Location
		factoryBean.setMapperLocations(resolver.getResources("classpath:admin/mapper/*.xml"));
		// MyBatis Plugins
		factoryBean.setPlugins(new Interceptor[] { new QueryRowBoundsInterceptor() });
		// Aliases Package
		factoryBean.setTypeAliasesPackage("com.stoneitgt.sogongja.admin.domain");
		// Configuration
