...
function sideInfoPopul(result, area, total, getarea) {
    ...
    if (area && result) {
        ...
        document.getElementById("sidebar").innerHTML = '<div id="sidebody">' + '<div class="sideinfo_fixed">' + '<div class="sideinfo">' + '<div class="areatitle iconPlus">' + area.area_name + '</div>' + '</div>' + '</div>' + '<div class="margintop"></div>' + '<div class="sideinfo float">' + '<h4 class="sideinfoTitle">인구수</h4>' + '<div class="groups_gray_20dp iconPlus">' + '총 ' + total_comma + '명' + '</div>' + '</div>' + '<div class="sideinfo float">' + '<h4 class="sideinfoTitle">주거인구</h4>' + '<div class="groups_gray_20dp iconPlus">' + r_popul + '명/ha' + '</div>' + '</div>' + '<div class="sideinfo float">' + '<h4 class="sideinfoTitle">직장인구</h4>' + '<div class="groups_gray_20dp iconPlus">' + w_popul + '명/ha' + '</div>' + '</div>' + '<div class="greyspan"></div>' + '<div class="sideinfo">' + '<h4 class="sideinfoTitle">대표자 연령대별 사업체</h4>' + '<div class="side_graph">' + '<canvas id="business"></canvas>' + '</div>' + '</div>' + '<div class="sideinfo">' + '<h4 class="sideinfoTitle">가구원수별 가구수</h4>' + '<ul class="short2">' + houseli + '</ul>' + '</div>' + '<div class="toggle_side" onclick="sideNoneVisible()" title="사이드바 숨기기"></div>' + '</div>' + '<div class="toggle_side side_visible" onclick="sideVisible()" title="사이드바 보이기"></div>';
        if (window.innerWidth < 767) {
            $('#sidebody').addClass('visible_none');
            $('#sidebar').addClass('on');
        }
